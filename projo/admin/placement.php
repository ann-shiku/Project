...
<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
    ...
    <tbody>
      <?php
      $sql = 'SELECT * FROM schools_selected  ';
      ...
      while ($row = mysqli_fetch_assoc($results)) {
       ...
       <td>' . $extra_county . '</td>
       <td>' . $county . '</td>
       <td> <button class="btn btn-primary " ><a class="text-light "  href="mailsend/index.php ?placeid='. $id .'">Place student</a></button>
       <button class="btn btn-danger "><a class="text-light "  href="deletes.php ?deleteid=' . $id. '">delete students</a></button>
     </tr>';
      }
